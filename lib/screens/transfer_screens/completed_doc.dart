...
import 'package:rootumex/screens/transfer_screens/transfer_completed_details.dart';
import 'package:rootumex/widgets/mainwrapper_widget.dart';

class CompletedDoc extends ConsumerStatefulWidget {
  const CompletedDoc(this.docNo, {super.key});
  final int docNo;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CompletedDocState();
}

class _CompletedDocState extends ConsumerState<CompletedDoc> {
  List<CustomEntry> comletedDocNo = [
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => Mainwrapper(
                                      child: TransferCompletedDetails(e.id)),
                                ));
                          },
                              Text(e.id.toString(),
