...
class ReturnCompletedDetails extends ConsumerStatefulWidget {
  const ReturnCompletedDetails(this.docNo, {super.key});
  final int docNo;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ReturnCompletedDetailsState();
}

class _ReturnCompletedDetailsState
    extends ConsumerState<ReturnCompletedDetails> {
