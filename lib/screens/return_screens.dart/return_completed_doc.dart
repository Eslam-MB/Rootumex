...
import 'package:rootumex/screens/return_screens.dart/return_completed_details.dart';
import 'package:rootumex/widgets/mainwrapper_widget.dart';

class ReturnCompletedDoc extends ConsumerStatefulWidget {
  const ReturnCompletedDoc(this.docNo, {super.key});
  final int docNo;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ReturnCompletedDocState();
}

class _ReturnCompletedDocState extends ConsumerState<ReturnCompletedDoc> {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => Mainwrapper(
                                      child: ReturnCompletedDetails(e.id)),
                                ));
                          },
                              Text(e.id.toString(),
