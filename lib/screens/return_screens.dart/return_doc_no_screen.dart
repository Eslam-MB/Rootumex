...
import 'package:rootumex/screens/return_screens.dart/return_item_details.dart';
import 'package:rootumex/widgets/mainwrapper_widget.dart';

class ReturnDocNoScreen extends ConsumerStatefulWidget {
  const ReturnDocNoScreen(this.docNo, {super.key});
  final int docNo;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ReturnDocNoScreenState();
}

class _ReturnDocNoScreenState extends ConsumerState<ReturnDocNoScreen> {
  List<CustomEntry> returnDocNo = [
