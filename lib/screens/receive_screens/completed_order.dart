...
import 'package:rootumex/screens/receive_screens/completed_details.dart';
import 'package:rootumex/widgets/mainwrapper_widget.dart';

class CompletedOrder extends ConsumerStatefulWidget {
  const CompletedOrder(this.orderNo, {super.key});
  final int orderNo;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CompletedOrderState();
}

class _CompletedOrderState extends ConsumerState<CompletedOrder> {
